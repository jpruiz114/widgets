	...
	<body>
		<div id="wrapper">
			<div id="top-bar">
				<ul>
					<li>
						<a href="/frontend-test/ContactForm/en" target="_self" data-i18n="contact-form.english-website"></a>
					</li>

					<li>
						<a href="/frontend-test/ContactForm/es" target="_self" data-i18n="contact-form.spanish-website"></a>
					</li>
				</ul>
			</div>
