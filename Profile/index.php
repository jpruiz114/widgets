    ...
    <body>
        <div id="wrapper">
            <div id="top-bar">
                <ul class="langs">
                    <li class="langs-item">
                        <a class="langs-link" href="<?php echo $basePath; ?>en" id="go-to-en-page" target="_self" data-i18n="[title]profile.english-website;profile.english-website"></a>
                    </li>

                    <li class="langs-item">
                        <a class="langs-link" href="<?php echo $basePath; ?>es" id="go-to-es-page" target="_self" data-i18n="[title]profile.spanish-website;profile.spanish-website"></a>
                    </li>
                </ul>
            </div>
            ...
            <div class="info-container" id="profile">
                <div id="profile-header">
                    ...
                    <div class="col" id="profile-data">
                        ...
                        <p class="unselectable-text" unselectable="on">
                            <label class="unselectable-text" id="followers-number" unselectable="on"></label>

                            <label class="unselectable-text" data-i18n="profile.followers" unselectable="on"></label>
                        </p>
                    </div>
                </div>
